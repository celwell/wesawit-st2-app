...
function _capture(type, successCallback, errorCallback, options) {
    var win = function(pluginResult) {
        ...
        for (i = 0; i < pluginResult.length; i++) {
            ...
            mediaFile.totalBytesWritten = pluginResult[i].totalBytesWritten;
            mediaFile.totalBytesExpectedToWrite = pluginResult[i].totalBytesExpectedToWrite;
            mediaFile.uploadType = pluginResult[i].uploadType;
