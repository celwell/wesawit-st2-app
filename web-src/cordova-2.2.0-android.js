...
cameraExport.getPicture = function(successCallback, errorCallback, options) {
    ...
    exec(successCallback, errorCallback, "WsiCamera", "takePicture", args);
};

cameraExport.cleanup = function(successCallback, errorCallback) {
    exec(successCallback, errorCallback, "WsiCamera", "cleanup", []);
};
...
define("cordova/plugin/capture", function(require, exports, module) { // modified by celwell
...
function _capture(type, successCallback, errorCallback, options) {
    var win = function(pluginResult) {
        ...
        for (i = 0; i < pluginResult.length; i++) {
            ...
            mediaFile.filePath = pluginResult[i].filePath;
            mediaFile.filePathMedium = pluginResult[i].filePathMedium;
            mediaFile.filePathThumb = pluginResult[i].filePathThumb;
            mediaFile.type = pluginResult[i].type;
            mediaFile.lastModifiedDate = pluginResult[i].lastModifiedDate;
            mediaFile.size = pluginResult[i].size;
            mediaFile.mid = pluginResult[i].mid;
            mediaFile.status = pluginResult[i].status;
            mediaFile.statusMedium = pluginResult[i].statusMedium;
            mediaFile.statusThumb = pluginResult[i].statusThumb;
            mediaFile.mediaType = pluginResult[i].mediaType;
            mediaFile.fileExt = pluginResult[i].fileExt;
            mediaFile.typeOfPluginResult = pluginResult[i].typeOfPluginResult;
            mediaFiles.push(mediaFile);
        }
        successCallback(mediaFiles);
    };
    exec(win, errorCallback, "WsiCapture", type, [options]);
}
/**
