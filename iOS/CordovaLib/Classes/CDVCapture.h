...
@interface CDVCapture : CDVPlugin <UIImagePickerControllerDelegate, UINavigationControllerDelegate, AmazonServiceRequestDelegate>
{
...
@property (nonatomic, strong) NSNumber *backgroundTaskId;
- (void)captureAudio:(CDVInvokedUrlCommand*)command;
- (void)captureImage:(CDVInvokedUrlCommand*)command;

- (void)processImage:(NSDictionary*)params;
- (void)captureVideo:(CDVInvokedUrlCommand*)command;
//- (void)processBackgroundThreadUploadInBackground:(NSData*)imageData forFileKey:(NSString*)key;
